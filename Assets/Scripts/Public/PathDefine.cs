public class PathDefine
{
    ...
    public const string DataContainerManagerTemplate = "Assets/Data/Templates/DataContainerManagerTemplate.txt";
    public const string AddContainerTemplate = "Assets/Data/Templates/AddContainerTemplate.txt";
