public class PathDefine
{
    ...
    public const string DataContainer = "Assets/Data/Scripts/Containers";
    public const string DataContainerTemplate = "Assets/Data/Templates/DataContainerTemplate.txt";
